...
class GifsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not able to get new if signed out" do
    get new_gif_url
    assert_response :redirect
    assert_redirected_to new_user_session_path
  end

  test "should able to get new if signed in" do
    sign_in users(:one)
    get new_gif_url
    assert_response :success
  end

  test "should redirect if create gif, but user not sign in" do
  ...
  test "should create gif" do
    ...
    assert_difference('Gif.count') do
      file = Rack::Test::UploadedFile.new("test/files/image.gif", "image/gif")
  ...
  test "should redirect if edit gif, but user not sign in" do
  ...
  test "should redirect if update gif, but user not sign in" do
  ...
  test "should redirect if destroy gif, but user not sign in" do
    delete gif_url(@gif)
    assert_response :redirect
    assert_redirected_to new_user_session_path
  end
